        subroutine analy(nmin,nminf,ncha,nchaf,parp22)   !Lei202302112
...
!Lei20230214B
!       parp22: select y or eta in partial phase-space statistics.
!               = 0 , y
!               = 1 , eta
!Lei20230214E
...
c060718     c   .or.(itden.eq.1.and.ipden.eq.1))then   ! 260314
        ...
        c(1)=yy
        if( ABS(parp22 - 1.).lt.1D-15 ) c(1)=eta   !Lei20230214 parp22 = 1
        c(2)=ppt
c       .
c       .
c       .
...
c       analyses for pp,pA and AB
        if(ipden.lt.11)
     &   call stati_h(yy,ppt,eta,p5,ik,kk,w,bn,an,bnf,anf,parp22)   !Lei20230214
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        subroutine stati_h(y,pt,eta,p5,ik,kk,ww,a,b,af,bf,parp22)   ! 260314 Lei20230214
